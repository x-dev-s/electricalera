...
export default function RootLayout({ children }) {
  ...
  var insertDropdownCat = function (type, gen) {
    ...
    if (type === "shopcat") { dropdownshophtml = html; }
  ...
  // CALLING FUNCTIONS 
  insertBlogNews("blogs"); insertBlogNews("news"); insertDropdownBlogNews("blogs"); insertDropdownBlogNews("news"); insertDropdownCat("blogcat", "blogs#"); insertDropdownCat("newscat", "news#"); insertDropdownCat("shopcat", "/shop.electricalera.com/collections/")
              ...
              <div className="container-fluid navbar-expand-md">
                ...
                <div className="collapse navbar-collapse" id="collapsable-nav">
                  <ul id="nav-list" className="my-auto ms-auto me-lg-auto navbar-nav">
                    ...
                    <li className="nav-item dropdown">
                      <a className="nav-link droplink" href="//shop.electricalera.com">
